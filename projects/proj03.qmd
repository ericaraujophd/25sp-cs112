...
::: tg-wrap
+------------------------------------------------------------------------+---------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------+
| \[Method name\]{style="color:unset;background-color:unset"}            | \[parameters\]{style="color:unset;background-color:unset"}    | \[return type\]{style="color:unset;background-color:unset"}                                                                                 |
+========================================================================+===============================================================+=============================================================================================================================================+
| \[findLocationToInsert()\]{style="color:unset;background-color:unset"} | \[int newScore\]{style="color:unset;background-color:unset"}  | \[int: the index of where to insert the newScore, or -1 if the score is not a new high score.\]{style="color:unset;background-color:unset"} |
+------------------------------------------------------------------------+---------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------+
| \[shiftUp()\]{style="color:unset;background-color:unset"}              | \[int fromIndex\]{style="color:unset;background-color:unset"} | \[void\]{style="color:unset;background-color:unset"}                                                                                        |
+------------------------------------------------------------------------+---------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------+
:::
