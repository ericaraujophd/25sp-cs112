...
[Accept the invitation](https://classroom.github.com/a/bnzHmKs1){target="_blank"} to the lab and do git clone to get the files, as usual. Make sure your partner is part of the same Team and edit the **README.md** file.
...
![](/images/labs/lab09/lab09-diagram.png){width="70%"}
...
Run the tests. If you pass the tests, congratulations! If not, use the diagrams above to go back and fix your `push()`, `peekTop()`, and/or `isFull()` methods. If you get stuck, here are hints for [push()](/labs/lab09-hint-push.qmd), [peekTop()](lab09-hint-peektop.qmd), and [isFull()](/labs/lab09-hint-isfull.qmd), but only use them if you have to.
